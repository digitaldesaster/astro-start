# Integrating Aceternity UI Components in Astro Projects
...
In your Astro pages, import and use the component with the `client:load` directive to ensure proper hydration:
